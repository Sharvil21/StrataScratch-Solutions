...
#Second Solution: This time without .agg() method and using .to_frame() method to convrt to dataframe and .reset_index() method to get the desired output for submission
# Import your libraries
import pandas as pd
